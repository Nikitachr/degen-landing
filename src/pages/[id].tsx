            ...
            <main className="w-full min-h-screen">
                ...
                <div className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="bg-white px-6 py-12 md:pl-12 md:py-40 md:pr-16 xl:pr-36">
                        ...
                        >
                            <Form className="w-full mt-5 mb-6 md:mb-12">
                                <TextField label="Address" name="address" type="text" />
                            </Form>
                        </Formik>
                        <div className="flex items-center gap-4">
                            <div className="w-5 min-w-5 h-5 rounded-full gap-5 bg-gray-400" />
                            <span className="text-gray-400 font-bold text-2xl">Your NFT card is waiting to be minted</span>
                        </div>
                        ...
                        <div className="bg-grayBg info-icon w-full mt-10 md:mt-20 p-3 rounded-2xl flex gap-3">
                            <InfoIcon/>
                            <p>You can activate minted NFT card as virtual debit card with the same skin at SaveChain app that will be available at <a
